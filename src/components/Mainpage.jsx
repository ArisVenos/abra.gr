            ...
            <Flex justifyContent='center' paddingTop="20px" paddingBottom="80px">
                <Card bg='white' boxShadow='lg' borderRadius='lg' width='900px'>
                    ...
                    <Heading textAlign="center" paddingBottom="20px" color="#c7260c" size="lg">ΑΜΠΡΑ ΚΑΤΑΜΠΡΑ</Heading>
                        ...
                        <Text mt="4" textAlign="center" paddingTop="20px">Τα<strong> παραμύθια ΑΜΠΡΑ ΚΑΤΑΜΠΡΑ</strong>, ένα πλούσιο έργο με την έγκριση 
                        του Υπ.Παιδείας και Θρησκευμάτων, περιλαμβάνουν τον κόσμο της παιδικής λογοτεχνίας σε 26
